...
lives_ok { $obj->config_b('value_b') }
'Can set config_b at runtime even when config_a is set';
...
lives_ok { $multi_obj->alt1('alt1_value') }
'Can set alt1 at runtime even when primary is set';
lives_ok { $multi_obj->alt2('alt2_value') }
'Can set alt2 at runtime even when primary is set';
